...
SECRET_KEY = 'django-insecure-bu=m&!dgjb$^qjkpth8j1wg$yd1feah(v3(-u)3+qi^)txi-i6'
...
EMAIL_USE_TLS = True
EMAIL_HOST_USER = ''
EMAIL_HOST_PASSWORD = '' # Not email password you get from account.gmail.com 'app password'
